...
INSERT INTO consultas VALUES ('2024-01-02 11:30', 'Tomás Hernández', '43123458', 'Margarita Mesa', 'SS');

-- Error: Violation of PRIMARY KEY constraint 'PK__consulta__E203A5E944104965'. Cannot insert duplicate key in object 'dbo.consultas'. The duplicate key value is (Jan  2 2024 11:30AM, Tomás Hernández).
