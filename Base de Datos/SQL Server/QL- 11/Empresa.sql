...
CREATE TABLE clientes (
  clie int NOT NULL DEFAULT 0,
  nombre varchar(50),
  repre tinyint DEFAULT NULL,
...
CREATE TABLE oficinas (
  numoficina tinyint NOT NULL DEFAULT 0,
  localidad varchar(50),
  zona varchar(50),
  dir tinyint DEFAULT 0,
...
--   ADD INDEX idfab (idfab),
--   ADD INDEX idproducto (idproducto);
