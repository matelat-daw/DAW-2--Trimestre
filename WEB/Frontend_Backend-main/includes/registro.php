<section class="container">
        ...
        <br><br>
        <div id="view1">
                <form class="row" action="registrar_usuario.php" method="post" enctype="multipart/form-data" onsubmit="return checkpass()">
                        ...
                        <div class="col">
                                ...
                                <small onclick="spy(1)" class="far fa-eye" id="toggle1" style="margin-left: -110px; cursor: pointer; visibility: hidden;"></small>
                                <br><br>
                                <label><input id="pass2" type="password" onkeypress="showEye(2)" required> Repite Contraseña</label>
                                <small onclick="spy(2)" class="far fa-eye" id="toggle2" style="margin-left: -159px; cursor: pointer; visibility: hidden;"></small>
                                <br><br>
                                <label><input type="date" name="fecha"> Fecha de Nacimiento</label>
                                <br><bR>
