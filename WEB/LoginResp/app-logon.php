...
?>
<button onclick="window.open('index.php')" style="width:250px; height:128px">Abrir página principal del Sitio</button> <!-- Este botón abre la página principal del sitio index.php. -->
<?php
