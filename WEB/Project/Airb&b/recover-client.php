...
if (isset($_POST["email"]))
{
    ...
    $sql = "SELECT client_email FROM client WHERE client_email='$email';"; // Preparo una consulta del E-mail del usuario.
    ...
    if ($stmt->rowCount() > 0) // Si el E-mail está en la base de datos, se prepara y se envía la contraseña por E-mail.
    {
        ...
        {
            $stmt = $conn->prepare("UPDATE client SET client_pass='$pass' WHERE client_email='$email';"); // Preparo una consulta para Actualizar la tabla.
