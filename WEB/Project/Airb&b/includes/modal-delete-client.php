...
<div class="modal fade" id="alertDialog" tabindex="-1" aria-labelledby="alertDialogLabel" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
  ...
  <div class="modal-content">
      ...
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="window.open('login-client.php', '_self')"></button>
      </div>
      ...
      <div class="modal-footer">
        <form action="kill-client.php" method="post">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
            <input type="submit" value="Elimino Mi Perfil" class="btn btn-danger btn-lg">
        </form>
        <button type="button" id="close_dialog" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.open('login-client.php', '_self')">Me Quedo</button>
      </div>
  </div>
  </div>
</div>