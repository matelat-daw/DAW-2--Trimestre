...
>>>>>>> 706c3668d0414ef0ae9665a8c90588603931d9f9
    ...
    public static void FilterPokemon(string rutaFichero) // Método para Guardar los Pokemon de 2 Tipos en un Fichero, en este caso es un método de prueba con una Lista de string que simula los Pokemon, para efectuar las pruebas de pasar rutas válidas y no válidas.
    {
