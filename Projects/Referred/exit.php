...
if (isset($_POST["id_user"])) // Si se recibió al menos una compra.
{
    $id_user = $_POST["id_user"]; // Asigno a la variable $id[$i] el valor de $_POST["id0"], la ID del evento.
    $id_business = $_POST["id_business"]; // El nombre del evento.
    $invoice = $_POST["invoice"]; // El Número de Factura.
