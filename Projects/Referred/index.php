                ...
                <div id="view2">
                    ...
                    <form action="logon.php" method="post">
                        <fieldset>
                            ...
                            <br><br>
                            <label><input type="password" name="pass2" required> Repite Contraseña</label>
                            <br><br>
                            <label><input type="date" name="bday" required> Fecha de Nacimiento</label>
                            <br><br>
                            <fieldset>
                                <legend>Como te Identificas</legend>
                                <label><input type="radio" name="gender" checked required> Mujer</label>
                                <label><input type="radio" name="gender" required> Varón</label>
                            </fieldset>
                            <br><br>
                            <label><input type="file" name="profile" required> Foto de Perfil<small>(Opcional)</small></label>
                            <br><br>
